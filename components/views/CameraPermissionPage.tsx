...
export function CameraPermissionPage({
  ...
  const containerVariants = {
    ...
    visible: {
      ...
      transition: {
        delayChildren: 0.1,
        staggerChildren: 0.1,
        // framer-motion expects a specific union type for `type`
  ...
  return (
    ...
    >
      ...
      <motion.p
        variants={itemVariants}
        className="text-gray-400 text-sm mt-4 leading-relaxed mb-10 px-4"
      >
        In order to take high quality purikura photos, please grant webcam
        access.
        <span className="text-white/60 block mt-1">
          We only process streams locally in your browser.
        </span>
      </motion.p>
      ...
      <div className="flex flex-col gap-4 relative z-10">
        <motion.button
          ...
          whileHover={{
            scale: 1.03,
            boxShadow: "0 0 25px rgba(234, 45, 45, 0.4)",
          }}
          whileTap={{ scale: 0.98 }}
          type="button"
